...
const Table: FC<Row> = () => {
        ...
        () => [
            ...
            },
            {
                ...
                filterSelectOptions: [
                    ...
                    {
                        text: "R&D工学部 共通科目",
                        value: "ロボティクス&デザイン工学部 共通科目",
                    },
                    {
                        text: "R&D工学部 その他連携科目",
                        value: "ロボティクス&デザイン工学部 その他連携科目",
                    },
                    {
                        text: "R&D工学部 専門横断科目",
                        value: "ロボティクス&デザイン工学部 専門横断科目",
                    },
                    {
                        text: "R&D工学部 ロボット工学科",
                        value: "ロボティクス&デザイン工学部 ロボット工学科",
                    },
                    {
                    ...
                    {
                        text: "情報科学部 情報システム学科",
                        value: "情報科学部 情報システム学科",
                    },
                    {
                        text: "情報科学部 情報メディア学科",
                        value: "情報科学部 情報メディア学科",
                    },
                    ...
                    {
                        text: "情報科学部 データサイエンス学科",
                        value: "情報科学部 データサイエンス学科",
                    },
                    ...
                    {
                        text: "知的財産学部 その他連携領域",
                        value: "知的財産学部 その他連携領域",
                    },
                    { text: "教職科目", value: "教職科目" },
                    {
                        text: "工学研究科 基礎および学際科目",
                        value: "工学研究科 基礎および学際科目",
                    },
                    ...
                    {
                        text: "工学研究科 電気電子・機械工学専攻",
                        value: "工学研究科 電気電子・機械工学専攻",
                    },
                    {
                    ...
                    {
                        text: "情報科学研究科 情報科学専攻",
                        value: "情報科学研究科 情報科学専攻",
                    },
                    {
                        text: "知的財産研究科 知的財産専攻",
                        value: "知的財産研究科 知的財産専攻",
                    },
    ...
    useEffect(() => {
        fetch(
            `https://raw.githubusercontent.com/yashikota/syllabus-scraping/master/data/${YEAR}table.json`,
        )
            .then((res) => res.json())
            .then((res) => {
    ...
    return (
        <>
            <Head>
                <title>
                    OITシラバスアプリ | 大阪工業大学 シラバス検索・閲覧アプリ
                </title>
                <meta
                    property="og:title"
