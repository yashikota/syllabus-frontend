    ...
    return (
        <Box p={2}>
            <Box mb={2} display="flex" gap={1}>
                ...
                <Button
                    variant={
                        isSorted("lecture_title") ? "contained" : "outlined"
                    }
                    color={
                        isSorted("lecture_title") === "asc"
                            ? "primary"
                            : "secondary"
                    }
                    onClick={() =>
                        setSorting([{ id: "lecture_title", desc: false }])
                    }
                    startIcon={
                        isSorted("lecture_title") === "asc" ? (
                            <ArrowUpwardIcon />
                ...
                <Button
                    ...
                    color={
                        isSorted("lecture_title") === "desc"
                            ? "primary"
                            : "secondary"
                    }
                    onClick={() =>
                        setSorting([{ id: "lecture_title", desc: true }])
                    }
                    startIcon={
                        isSorted("lecture_title") === "desc" ? (
                            <ArrowDownwardIcon />
                ...
                <Button
                    ...
                    color={
                        isSorted("department") === "asc"
                            ? "primary"
                            : "secondary"
                    }
                    onClick={() =>
                        setSorting([{ id: "department", desc: false }])
                    }
                    startIcon={
                        isSorted("department") === "asc" ? (
                            <ArrowUpwardIcon />
                ...
                <Button
                    variant={isSorted("department") ? "contained" : "outlined"}
                    color={
                        isSorted("department") === "desc"
                            ? "primary"
                            : "secondary"
                    }
                    onClick={() =>
                        setSorting([{ id: "department", desc: true }])
                    }
                    startIcon={
                        isSorted("department") === "desc" ? (
                            <ArrowDownwardIcon />
